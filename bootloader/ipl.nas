...
HEADER	EQU		2				; Number of heads
		...
		DB		0				; 36      Logical Drive Number (for use with INT 13, e.g. 0 or 0x80)
...
; DL = driver
; ES:BX = buffer
;return value：FLAGS.CF == 0 no error，AH = 0；FLAGS.CF == 1 error occurred，AH - error number
...
msg:
		...
		RESB	0x7dfe-$		; 0x7c00+0x0200-0x0002.
